...
fun VerticalTread(
    ...
    Box(
        ...
        Canvas(
            ...
            val segment = factor.times(bottomRegion - strokeLine.dp.toPx().times(2f)).div(100f)
            ...
            for (it in 0 until 7) {
                ...
                val value = percentage.times(bottomRegion - strokeLine.dp.toPx().times(2f))
                    .div(100f) + p0.y + strokeLine
            ...
            val yLine = (regionPlot - (sweep.value - minPressure) /
                    (maxPressure - minPressure) * (regionPlot - strokeLine.dp.toPx()
                .times(2f))).plus(topRegion)
            drawLine(
